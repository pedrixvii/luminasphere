			...
			<div class="authentication-inner">
				...
				<div class="card">
					<div class="card-body">
						...
						<!-- /Logo -->
						<h4 class="mb-2">Welcome to LuminaSphere 👋</h4>
						<p class="mb-4">Please sign-in to your account and enjoy read book </p>
						...
						<form id="formAuthentication" class="mb-3" action="<?= site_url('auth/attempt_login'); ?>" method="POST">
							<div class="mb-3">
						...
						<p class="text-center">
							...
							<a href="<?= base_url('auth/register_user') ?>">
