		...
		<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
			...
			<ul class="menu-inner py-1">
				...
				<li class="menu-item <?= ($current_page == 'dashboard') ? 'active' : '' ?>">
					<a href="<?= base_url('dashboard/staff') ?>" class="menu-link">
				...
				<li class="menu-item">
					...
					<ul class="menu-sub">
						<li class="menu-item <?= ($current_page == 'approved') ? 'active' : '' ?>">
							<a href="<?= base_url('approved') ?>" class="menu-link">
								<div data-i18n="Account">Data E-Book</div>
							</a>
						</li>
						<li class="menu-item <?= ($current_page == 'deposit') ? 'active' : '' ?>">
							<a href="<?= base_url('deposit') ?>" class="menu-link">
								<div data-i18n="Account">Data Deposit</div>
							</a>
						</li>
					</ul>
				</li>
