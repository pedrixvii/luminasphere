  ...
  <footer class="content-footer footer bg-footer-theme">
    ...
    <!-- Vendors JS -->
    <script src="<?= base_url('assets/sneat-1.0.0') ?>/assets/vendor/libs/apex-charts/apexcharts.js"></script>

    <!-- Main JS -->
    <script src="<?= base_url('assets/sneat-1.0.0') ?>/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="<?= base_url('assets/sneat-1.0.0') ?>/assets/js/dashboards-analytics.js"></script>
